/**
 * Default Content Pack - TypeScript Constant
  ...
  steps: [
    {
      ...
      scenario:
        "Congrats! You just raised your Seed round 🥳. Time to show progress building AI Cofounder. Your first technical decisions will set the foundation for everything that follows.",
      optionA: {
    ...
    },
    {
      ...
      scenario:
        "Early adopters are trying your AI Cofounder. The big challenge: do they stick around? Your onboarding experience will make or break retention.",
      optionA: {
        label: "Create Bold Landing Page",
        body: "Generate a bold, funny landing page with '🔥 Replace your cofounder with AI (without the equity drama).' Drive acquisition through viral marketing, but user activation still needs work.",
    ...
    },
    {
      ...
      scenario:
        "Founders love AI Cofounder, but now they're asking: Can it do more? Time to expand beyond the MVP and add features that drive real value.",
      optionA: {
    ...
    },
    {
      ...
      scenario:
        "AI Cofounder gets featured on Product Hunt 🚀. Thousands of desperate founders sign up overnight. Your infrastructure and support systems are about to be stress-tested like never before.",
      optionA: {
    ...
    },
    {
      ...
      scenario:
        "Founders around the world want their own AI Cofounder 🌍. Time to globalize. Your decisions here will determine if you can scale internationally or remain a US-only product.",
      optionA: {
      ...
      optionB: {
        ...
        body: "Integrate global payment providers so founders in Berlin, Tokyo, and São Paulo can pay in EUR, JPY, BRL. Unlock global revenue but complex financial compliance.",
