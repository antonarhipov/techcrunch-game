	...
	return (
		<div className="h-screen overflow-hidden flex flex-col bg-gray-950">
			...
			<div className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-5 gap-4 p-4">
				...
				<div className="lg:col-span-2 overflow-auto bg-gray-800 rounded-lg shadow-md border border-gray-700 p-6">
					{scenarioPanel}
				</div>
			...
			<div className="shrink-0 bg-gray-800 border-t border-gray-700 shadow-lg">
				{meterPanel}
			</div>
		</div>
	);
